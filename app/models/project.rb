...
class Project < ApplicationRecord
  ...
  after_create :generate_default_content!, if: proc { |p| generate_default_content == '1' || generate_default_content == true }
  after_create :generate_basic_content!, unless: proc { |p| generate_default_content == '1' || generate_default_content == false }
