...
class SubSectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sub_section" do
    assert_difference('SubSection.count') do
      post sub_sections_url, params: { sub_section: { content: @sub_section.content, section_id: @sub_section.section_id, title: @sub_section.title } }
    end
  ...
  test "should update sub_section" do
    patch sub_section_url(@sub_section), params: { sub_section: { content: @sub_section.content, section_id: @sub_section.section_id, title: @sub_section.title } }
